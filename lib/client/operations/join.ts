...
export async function awaitJoinResponse(client: IClient, channelName: string): Promise<RoomState> {
...
export async function joinChannel(client: IClient, channelName: string): Promise<RoomState> {
