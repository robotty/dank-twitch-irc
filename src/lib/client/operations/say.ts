...
export async function say(client: Client, channelName: string, message: string): Promise<UserstateMessage> {
...
export async function me(client: Client, channelName: string, message: string): Promise<UserstateMessage> {
